...
namespace MobileClient.Views
{
    ...
    public partial class PurchasePageRefactored : ContentPage
    {
        ...
        public PurchasePageRefactored(IAlertService alertService,
        ...
        private static string GetLegalJargon(SubscriptionType selected, ValidationResponse validation)
        {
            ...
            {
                case SubscriptionType.Premium:
                    costDesc = $"${SubscriptionUtilities.PremiumPrice.ToString()} monthly";
                    break;
                case SubscriptionType.Enterprise:
                    costDesc = $"${SubscriptionUtilities.EnterprisePrice.ToString()} monthly";
                    break;
                default:
                    costDesc = $"${SubscriptionUtilities.BasicPrice.ToString()} monthly";
                    break;
            }
